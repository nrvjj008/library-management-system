           ...
           <div className={"flex w-full  flex-wrap p-4"}>
            ...
            <div className={" w-3/4 flex flex-col mx-auto my-auto  p-4 py-8 "}>
                ...
                <div className={" flex flex-col justify-around  space-y-6 bg-gold/50 rounded relative py-8 w-full"} >
                    <p className={"text-black text-xl  lg:text-2xl font-extrabold  px-4 "} dir={"rtl"}>منصة مكتبة نَسق للإبداع والأبحاث والدراسات النظرية المتخصصة في العمارة والفنون البصرية والفيلم والموسيقى والتصميم، وهي
                    منصة غير ربحيّة، تُعنى بتوفير المصادر والمراجع الفنية، لإثراء المحتوى الفني والعربي. كما تطمح نَسق في المساهمة بنشر المعرفة
                    </p>
                    <p className={"text-black text-xl  lg:text-2xl font-extrabold  px-4 "} dir={"rtl"}>تنطلق نسق كمكتبة مرجعية لمصادر ومراجع الإبداع والفنون، رغم أن طموحاتها تذهب لأبعد من ذلك في المستقبل. إذ بدأت بالفعل
